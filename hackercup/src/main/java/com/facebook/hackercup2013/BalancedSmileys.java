 ...
 * parentheses. - A smiley face ":)" or a frowny face ":(" Write a program that
 * determines if there is a way to interpret his message while leaving the
 * parentheses balanced.
 * 
 * Input The first line of the input contains a number T (1 ≤ T ≤ 50), the
 * number of test cases. The following T lines each contain a message of length
 * s that you got from John.
 * 
 * Output For each of the test cases numbered in order from 1 to T, output
 * "Case #i: " followed by a string stating whether or not it is possible that
 * the message had balanced parentheses. If it is, the string should be "YES",
 * else it should be "NO" (all quotes for clarity only)
 * 

 ...
 * 5}.
 * 
 * Example: linearPartition([9,2,6,3,8,5,8,1,7,3,4], 3) =>
 ...
 * @see http
 *      ://www8.cs.umu.se/kurser/TDBAfl/VT06/algorithms/BOOK/BOOK2/NODE45.HTM
 * @see http
 *      ://www.crispymtn.com/stories/the-algorithm-for-a-perfectly-balanced-photo
 *      -gallery
 * 
 */
public class PainterPartition {
	...
	public int[][] linearPartition(int[] a, int k) {
		...
		for (int i = k - 1; i >= 0; i--) {
			int from = d[to][i];
			solution[i] = Arrays.copyOfRange(a, from, to + 1);
			to = from - 1;
		}
	...
	public static void main(String[] args) {
		...
		int[] a = new int[]{9,2,6,3,8,5,8,1,7,3,4};
		int k = 3;
		int[][] solution = partitioner.linearPartition(a, k);

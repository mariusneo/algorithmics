package org.problems.project.euler.problem11;
...
public class Problem11 {
	...
	private static int[][] readMatrixFromFile(){
        ...
        try {
            String thisLine;
            InputStream in = Problem11.class.getResourceAsStream("in.txt");

            //from here is the clasic approach - read bytes, characters, 
            //lines in Java style           
            ...
            while ((thisLine = br.readLine()) != null) {
                ...
                for (int column = 0;column<numbers.length;column++){
                	matrix[line][column] = Integer.parseInt(numbers[column]);
                }
            }
